...
bang_call_percent = round(bang_land_call_count / call_count,2)
print(f"{bang_call_percent} percent of calls from fixed lines in Bangalore are calls to other fixed lines in Bangalore.")
